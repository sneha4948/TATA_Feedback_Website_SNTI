<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm3.aspx.cs" Inherits="snti.WebForm3" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div align="center" class="container jumbotron bg-light " style="width: 65%">
            <form>
                <br />
                <br />
                ...
                <asp:Button ID="Button2" runat="server" Text="Clear Form" CssClass="btn btn-primary" />
                <div>
